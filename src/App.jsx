        ...
        <div style={{
                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                              0% { background-position: -200% center; }
                                                                                                                                                                                                                                                                                        100% { background-position: 200% center; }
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                @keyframes borderGlow {
                                                                                                                                                                                                                                                                                                                          0%, 100% { border-color: rgba(168,85,247,0.1); box-shadow: 0 0 20px rgba(168,85,247,0); }
                                                                                                                                                                                                                                                                                                                                    50% { border-color: rgba(168,85,247,0.3); box-shadow: 0 0 30px rgba(168,85,247,0.15); }
                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          -webkit-text-fill-color: transparent;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    background-clip: text;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            .gradient-text-shimmer {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      background: linear-gradient(90deg, #E879F9 0%, #A855F7 25%, #7C3AED 50%, #A855F7 75%, #E879F9 100%);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              .hero-badge { animation: fadeInUp 0.8s ease-out forwards, float 4s ease-in-out infinite 1s; }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      .hero-title { animation: fadeInUp 0.8s ease-out 0.2s forwards; opacity: 0; }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              .hero-subtitle { animation: fadeInUp 0.8s ease-out 0.4s forwards; opacity: 0; }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      .hero-cta { animation: fadeInUp 0.8s ease-out 0.6s forwards; opacity: 0; }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              .hero-cta-secondary { animation: fadeInUp 0.8s ease-out 0.75s forwards; opacity: 0; }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        .nav-link { transition: color 0.2s ease; }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                .nav-link:hover { color: #A855F7; }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                /* Background Orb Pulse */
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        .orb-pulse { animation: pulseGlow 4s ease-in-out infinite; }
          ...
          {/* Background Orbs */}
              <div style={{ position: 'fixed', inset: 0, overflow: 'hidden', pointerEvents: 'none', zIndex: 0 }}>
                    ...
                    borderRadius: '50%', transform: `translateY(${scrollY * 0.15}px)`, animationDelay: '1s'
        }} />
                      <div className="orb-pulse" style={{
                    position: 'absolute', bottom: '-10%', right: '20%', width: '400px', height: '400px',
                    background: 'radial-gradient(circle, rgba(124,58,237,0.12) 0%, transparent 70%)',
                    borderRadius: '50%', transform: `translateY(${scrollY * -0.1}px)`, animationDelay: '2s'
        }} />
                      <div style={{
                  ...
                  padding: isMobile ? '120px 20px 60px' : '0 48px', position: 'relative', zIndex: 1
                      ...
                      maxWidth: '600px', lineHeight: 1.6, marginBottom: '48px'
                                ...
                                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                                            <a href="#services" className="cta-button hero-cta" style={{
              ...
              <section id="services" style={{ padding: isMobile ? '60px 20px' : '120px 48px', position: 'relative', zIndex: 1 }}>
                      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                        ...
                        <div
                                          key={service.id}
                                          data-id={service.id}
                                          className={`service-card ${visibleCards[service.id] ? 'visible' : ''}`}
              ...
              <section id="results" style={{ padding: isMobile ? '60px 20px' : '100px 48px', position: 'relative', zIndex: 1 }}>
                    ...
                    border: '1px solid rgba(168,85,247,0.1)', padding: isMobile ? '40px 24px' : '60px 40px'
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: isMobile ? '32px 16px' : '48px 32px', maxWidth: '700px', margin: '0 auto' }}>
                                  {[
          { value: '127', suffix: 'M+', label: 'Monthly Community Viewers' },
          { value: '50', suffix: '+', label: 'Communities We Run' },
          { value: '35', suffix: '+', label: 'Brands Trust Memeta' },
          { value: '24/7', suffix: '', label: 'Reputation Monitoring' }
                      ].map((stat, i) => (
                                      <div key={i} style={{ textAlign: 'center' }}>
                                                      <div className="stat-value" style={{
                                                        ...
                                                        {stat.value === '24/7' ? stat.value : <AnimatedCounter target={stat.value} suffix={stat.suffix} duration={2000} />}
                                                      </div>div>
