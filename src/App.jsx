                  ...
                  <section style={{
                          ...
                          <div style={{ maxWidth: '1000px' }}>
                              ...
                              marginBottom: '24px'
                                                ...
                                                Occupy<br />
                                                <span className="gradient-text" style={{ fontStyle: 'italic', paddingRight: '8px', display: 'inline-block' }}>Mindshare.</span>
                                    </h1>
                                                      ...
                                                      {service.benefits.map((benefit, i) => (
                                                                              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                                                                                                    ...
                                                                                                    <div>
                                                                                                                            ...
                                                                                                                            <span style={{ fontSize: '13px', color: 'rgba(250,250,250,0.4)', marginLeft: '8px' }}>
                                                                                                                                  {benefit.detail}
                                                                                                                                  </span>
                                                                                                          </div>
                                                                              </div>
                  ...
                  <section id="results" style={{
                          ...
                          <div style={{
                            ...
                            padding: isMobile ? '40px 24px' : '60px 40px'
                              ...
                              gap: isMobile ? '32px 16px' : '48px 32px',
                              maxWidth: '700px',
                              margin: '0 auto'
            }}>
                                          {[
                  ...
                  <section id="contact" style={{
                          ...
                          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                                    <div style={{ marginBottom: '32px' }}>
                                                <MemetaLogo size={isMobile ? 60 : 80} glowColor="rgba(168,85,247,0.3)" />
                                    </div>
                  ...
                  <footer style={{
                          ...
                          <div style={{
                            ...
                            gap: '24px'
                                    ...
                                    <span style={{ fontSize: '13px', color: 'rgba(250,250,250,0.3)' }}>
                                                © 2025 Memeta. Occupy Mindshare.
                                    </span>
                          </div>
                  </footer>
            </div>
